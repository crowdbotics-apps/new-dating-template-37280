...
## Project Structure
    ...
    ├── new_dating_template_37280  # Django project configurations
...
1. Clone this repo and `cd new_dating_template_37280`
...
2. Clone this repo and `cd new_dating_template_37280`
